    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header" data-background-color="purple">
                <h1 class="title"><i class="fa fa-group fa-fw"></i> Mahasiswa Teknik Informatika</h1>
            </div>
        </div>
        <div class="col-lg-12">
            <ol class="breadcrumb">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ url("mahasiswa/add") }}" class="form-horizontal" method="POST">
                    <div class="form-group">
                        <label class="control-label col-sm-2" for="nim" required>NIM:</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="nim" maxlength="11"
...
<div class="modal fade" id="modalUbah" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ url("mahasiswa/update") }}" class="form-horizontal" method="POST">
                    <div class="form-group">
...
<div class="panel panel-default">
    <div class="panel panel-heading">
        <a href="" data-toggle="modal" data-target="#modalTambah"><span
                    class="btn btn-primary fa fa-plus-circle btn-lg"> Tambah Data Mahasiswa</span></a>
    </div>
