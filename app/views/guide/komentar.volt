                        ...
                        <div class="card">
                            ...
                            <div class="card-content">
                                <div class="form-group">
                                    ...
                                    <a href="docs_ta/pengajuan/{{ data3.nim }}/{{ data3.doc_proposal }}" target="_blank" class="btn btn-info">Download</a>
                                </div>
                                <div class="">
                                    <h3>Komentar</h3> {% for komentars in komentar %} {% if data3.id_pengajuan == komentars.kd_pengajuan %} {#
                                    <p>{{ komentars.kd_pengajuan }}</p>#}
                                    <p>Author : {{ komentars.author }}</p>
                                    <p>Komentar : {{ komentars.content }}</p>
                                    <p>Tanggal / Jam : {{ komentars.create_time }}</p>
                                    <hr style="color: red"> {% endif %} {% endfor %}
                                </div>
                            </div>
                            <div class="card-footer">
                                <form action="komentar/create" method="post">
                                    <div class="form-group">
                                        ...
                                        <input type="text " name="nama" readonly class="form-control text-primary" value="{{ session.nama }}">
                                        <label for=""><span class="text-danger">Komentar</span></label>
                                        <textarea name="comment" id="comeent" cols="30" rows="2" class="form-control" placeholder="Tulis Komentar"></textarea>
