                    ...
                    <div class="table-responsive">
                        <table class="table table-hover ">
                            ...
                            {% for data2 in pengajuan2 %}
                                {% if data2.status == 'proses_review' and data2.reviewer_1 == session.nip_nim and data2.nilai_1 != 0 %}
                                            ...
                                            <td><a href="docs_ta/pengajuan/{{ data2.nim }}/{{ data2.doc_proposal }}" target="blank">Proposal Tugas Akhir</a>
                                                ...
                                                <td>
                                                    <div class="btn-group btn-group-sm btn-group-vertical">
                                                        ...
                                                        {{ link_to("nilai/setnilai/" ~ data2.nim,'Nilai ' , "class":"btn btn-success") }}
                                                    </div>
                                                </td>
                                            </tr>
                                ...
                                {% elseif data2.status == 'proses_review' and data2.reviewer_2 == session.nip_nim and data2.nilai_2 != 0 %}
