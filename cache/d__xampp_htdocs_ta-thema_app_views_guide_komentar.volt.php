                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-content">
                                ...
                                <div class="">
                                    <h3>Komentar</h3> <?php foreach ($komentar as $komentars) { ?> <?php if ($data3->id_pengajuan == $komentars->kd_pengajuan) { ?> 
                                    <p>Author : <?= $komentars->author ?></p>
                                    <p>Komentar : <?= $komentars->content ?></p>
                                    <p>Tanggal / Jam : <?= $komentars->create_time ?></p>
                                    <hr style="color: red"> <?php } ?> <?php } ?>
                                </div>
                            </div>
                            <div class="card-footer">
                                <form action="komentar/create" method="post">
                                    <div class="form-group">
                                        ...
                                        <input type="text " name="nama" readonly class="form-control text-primary" value="<?= $this->session->nama ?>">
