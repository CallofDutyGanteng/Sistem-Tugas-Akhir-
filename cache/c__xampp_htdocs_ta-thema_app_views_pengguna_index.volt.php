                                                                ...
                                                                <div class="panel panel-body">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select name="hak_akses" id="hak_akses" class="form-control">
                                                                            <option <?php if ($d->hak_akses == 'administrator') { ?><?= 'selected' ?>
                                                                                    value="administrator">Administrator
                                                                            </option>
                                                                            <option <?php } elseif ($d->hak_akses == 'dosen') { ?><?= 'selected' ?>
                                                                                    value="dosen">Dosen
                                                                            </option>
                                                                            <option <?php } elseif ($d->hak_akses == 'mahasiswa') { ?><?= 'selected' ?>
                                                                                    value="mahasiswa">Mahasiswa
                                                                            </option>
                                                                            <option <?php } elseif ($d->hak_akses == 'kordinatorTA') { ?><?= 'selected' ?><?php } ?>
