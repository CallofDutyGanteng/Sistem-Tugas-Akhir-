                    ...
                    <div class="table-responsive">
                        <table class="table table-hover ">
                            ...
                            <?php foreach ($pengajuan2 as $data2) { ?>
                                <?php if ($data2->status == 'proses_review' && $data2->calon_pembimbing_1 == $this->session->nip_nim) { ?>
                                ...
                                <?php } elseif ($data2->status == 'proses_review' && $data2->calon_pembimbing_2 == $this->session->nip_nim) { ?>
