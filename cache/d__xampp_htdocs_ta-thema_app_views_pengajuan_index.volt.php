...
<div class="view">
    ...
    <?php foreach ($syarat_review as $s) { ?>
    <div class="col-sm-4 card-large">
        <div class="card large primary">
            <div class="card-image">
                <img src='docs_ta/pengajuan/<?= $this->session->nip_nim ?>/<?= $s ?>' alt="">
            </div>
        </div>
    </div>
    <?php } ?>
...
<div class="update">
    ...
    <?= $this->tag->form(['Pengajuan/update', 'rule' => 'form', 'enctype' => 'multipart/form-data']) ?>
        <div class="col-lg-6">
            ...
            <div class="form-group">
                ...
                <select name="calon_pembimbing_1" class="form-control">
                    ...
                    <option <?php if ($d->nip == $data_pengajuan->calon_pembimbing_1) { ?><?= 'selected' ?><?php } ?> value="<?= $d->nip ?>"><?= $d->nama ?></option>
                    <?php } ?>
                </select>
            </div>
            <div class="form-group">
                ...
                <select name="calon_pembimbing_2" class="form-control">
                    <?php foreach ($dosen as $d) { ?>
                    <option <?php if ($d->nip == $data_pengajuan->calon_pembimbing_2) { ?><?= 'selected' ?><?php } ?> value="<?= $d->nip ?>"><?= $d->nama ?></option>
                    <?php } ?>
                </select>
            </div>
        </div>
